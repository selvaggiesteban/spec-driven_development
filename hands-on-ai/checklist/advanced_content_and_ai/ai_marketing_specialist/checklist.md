# Compliance Checklist: AI_MARKETING_SPECIALIST
...
This document serves as the absolute source of truth for auditing the performance and compliance of the ai_marketing_specialist. All items must be verified.
...
## 8. Final Sign-Off
By signing below, the auditor certifies that the ai_marketing_specialist implementation meets the agency's strict standards.

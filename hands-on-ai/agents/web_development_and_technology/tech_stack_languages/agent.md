# Agent Authority Profile: TECH_STACK_LANGUAGES
...
This document defines the capabilities, constraints, and operational standards for the tech_stack_languages agent.

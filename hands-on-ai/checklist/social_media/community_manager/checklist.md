# Compliance Checklist: COMMUNITY_MANAGER
Domain: SOCIAL_MEDIA | Type: AUDIT & VERIFICATION | Status: MANDATORY
================================================================================

## 1. Executive Summary & Audit Scope
The social media checklist ensures operational excellence in its domain.
This document serves as the absolute source of truth for auditing the performance and compliance of the community_manager. All items must be verified.
...
## 8. Final Sign-Off
By signing below, the auditor certifies that the community_manager implementation meets the agency's strict standards.

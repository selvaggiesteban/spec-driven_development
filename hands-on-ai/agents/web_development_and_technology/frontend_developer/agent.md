# Agent Authority Profile: FRONTEND_DEVELOPER
...
This document defines the capabilities, constraints, and operational standards for the frontend_developer agent.

# Skill Mastery Definition: API_INTEGRATIONS_DEVELOPER
Domain: WEB_DEVELOPMENT_AND_TECHNOLOGY | Type: SKILL | Authority: ABSOLUTE
================================================================================
...
This document defines the capabilities, constraints, and operational standards for the api_integrations_developer skill.
...
- [MANDATE]: API documentation must follow the OpenAPI 3.1 specification and be automatically generated.
  > Rationale: Ensures long-term scalability and reduces technical debt.
- [MANDATE]: State management must be deterministic and replayable (e.g., Redux/Event Sourcing).
  > Rationale: Ensures long-term scalability and reduces technical debt.
- [MANDATE]: Micro-frontends must be decoupled via build-time composition or strict runtime contracts.
  > Rationale: Ensures long-term scalability and reduces technical debt.
...
- Metric: DORA Metrics (Deployment Frequency, Lead Time, MTTR, Change Failure Rate)
- Metric: Performance: Core Web Vitals (LCP < 2s, CLS < 0.1)
- Metric: Code Coverage > 85%

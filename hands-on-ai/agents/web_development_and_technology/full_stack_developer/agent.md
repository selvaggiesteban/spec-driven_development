# Agent Authority Profile: FULL_STACK_DEVELOPER
...
This document defines the capabilities, constraints, and operational standards for the full_stack_developer agent.

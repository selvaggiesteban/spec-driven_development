# Agent Authority Profile: TECHNICAL_PRODUCT_MANAGER
Domain: DIRECTION_AND_STRATEGY | Type: AGENT | Authority: ABSOLUTE
================================================================================

## 1. Executive Summary
The direction and strategy domain represents a critical pillar of our 2026 operations.
This document defines the capabilities, constraints, and operational standards for the technical_product_manager agent.

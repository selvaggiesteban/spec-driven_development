# Agent Authority Profile: QA_AUTOMATION_ENGINEER
...
This document defines the capabilities, constraints, and operational standards for the qa_automation_engineer agent.

# Agent Authority Profile: WEB_SECURITY_SPECIALIST
...
This document defines the capabilities, constraints, and operational standards for the web_security_specialist agent.

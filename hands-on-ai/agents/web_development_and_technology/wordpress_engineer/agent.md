# Agent Authority Profile: WORDPRESS_ENGINEER
...
This document defines the capabilities, constraints, and operational standards for the wordpress_engineer agent.

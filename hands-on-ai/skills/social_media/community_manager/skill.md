# Skill Mastery Definition: COMMUNITY_MANAGER
Domain: SOCIAL_MEDIA | Type: SKILL | Authority: ABSOLUTE
================================================================================

## 1. Executive Summary
The social media domain represents a critical pillar of our 2026 operations.
This document defines the capabilities, constraints, and operational standards for the community_manager skill.

# Compliance Checklist: UX_UI_DESIGNER
...
This document serves as the absolute source of truth for auditing the performance and compliance of the ux_ui_designer. All items must be verified.
...
## 8. Final Sign-Off
By signing below, the auditor certifies that the ux_ui_designer implementation meets the agency's strict standards.

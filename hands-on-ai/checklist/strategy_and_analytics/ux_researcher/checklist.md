# Compliance Checklist: UX_RESEARCHER
...
This document serves as the absolute source of truth for auditing the performance and compliance of the ux_researcher. All items must be verified.
...
## 8. Final Sign-Off
By signing below, the auditor certifies that the ux_researcher implementation meets the agency's strict standards.

# Agent Authority Profile: SOFTWARE_ARCHITECT
...
This document defines the capabilities, constraints, and operational standards for the software_architect agent.

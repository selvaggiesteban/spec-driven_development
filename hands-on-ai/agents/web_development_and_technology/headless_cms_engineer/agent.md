# Agent Authority Profile: HEADLESS_CMS_ENGINEER
...
This document defines the capabilities, constraints, and operational standards for the headless_cms_engineer agent.

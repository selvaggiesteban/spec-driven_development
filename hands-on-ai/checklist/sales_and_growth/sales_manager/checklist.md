# Compliance Checklist: SALES_MANAGER
...
This document serves as the absolute source of truth for auditing the performance and compliance of the sales_manager. All items must be verified.
...
## 8. Final Sign-Off
By signing below, the auditor certifies that the sales_manager implementation meets the agency's strict standards.

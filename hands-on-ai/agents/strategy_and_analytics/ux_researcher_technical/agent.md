# Agent Authority Profile: UX_RESEARCHER_TECHNICAL
Domain: STRATEGY_AND_ANALYTICS | Type: AGENT | Authority: ABSOLUTE
================================================================================

## 1. Executive Summary
The strategy and analytics domain represents a critical pillar of our 2026 operations.
This document defines the capabilities, constraints, and operational standards for the ux_researcher_technical agent.

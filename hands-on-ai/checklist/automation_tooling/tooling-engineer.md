# Compliance Checklist: TOOLING-ENGINEER
...
This document serves as the absolute source of truth for auditing the performance and compliance of the tooling-engineer. All items must be verified.
...
## 8. Final Sign-Off
By signing below, the auditor certifies that the tooling-engineer implementation meets the agency's strict standards.

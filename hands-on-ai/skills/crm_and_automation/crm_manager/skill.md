# Skill Mastery Definition: CRM_MANAGER
Domain: CRM_AND_AUTOMATION | Type: SKILL | Authority: ABSOLUTE
================================================================================

## 1. Executive Summary
The crm and automation domain represents a critical pillar of our 2026 operations.
This document defines the capabilities, constraints, and operational standards for the crm_manager skill.
